...
export const skills: Skill[] = [
    ...
    { name: 'PHP', level: 80, category: 'backend', color: '#777BB4' },
    { name: 'MySQL', level: 82, category: 'backend', color: '#4479A1' },
    { name: 'PostgreSQL', level: 50, category: 'backend', color: '#336791' },
    ...
    // Design
    { name: 'Figma', level: 70, category: 'design', color: '#F24E1E' },
    { name: 'Excalidraw', level: 60, category: 'design', color: '#FF61F6' }
