...
export const Contact: React.FC = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        setIsVisible(entry.isIntersecting); // 🔄 ahora vuelve a false al salir
      },
      { threshold: 0.1 }
    );
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-400">
            ¿Tienes una idea genial? ¿Necesitas ayuda con tu proyecto? Me
            encantaría escucharte y ver cómo podemos trabajar juntos.
          </p>
        </div>
            ...
            <div className="p-8 bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
              ...
              <div className="p-4 mt-6 border border-blue-200 rounded-lg bg-blue-50 dark:bg-blue-900/20 dark:border-blue-800">
                <p className="text-sm text-blue-800 dark:text-blue-400">
                  💡 <strong>Tip:</strong> Mientras más detalles me proporciones
                  sobre tu proyecto, mejor podré entender tus necesidades y
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="p-6 bg-white shadow-lg dark:bg-gray-800 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Comenzamos con una consulta inicial, seguida de planificación
                detallada, desarrollo iterativo con feedback constante, y
                entrega final con soporte.
              </p>
            </div>
            ...
            <div className="p-6 bg-white shadow-lg dark:bg-gray-800 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Depende de la complejidad. Un sitio web simple puede tomar 2-4
                semanas, mientras que aplicaciones más complejas pueden requerir
                2-6 meses.
              </p>
            </div>
            ...
            <div className="p-6 bg-white shadow-lg dark:bg-gray-800 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                distribuidos usando herramientas como Slack, Zoom, GitHub y
                metodologías ágiles.
              </p>
            </div>
          </div>
